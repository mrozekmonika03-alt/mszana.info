-- ================================================
-- LICZNIK WYŚWIETLEŃ STRONY (Supabase)
-- Jak użyć:
--   1. https://supabase.com/dashboard → projekt → SQL Editor → New query
--   2. Wklej całość → RUN (Ctrl+Enter)
--   3. Licznik zacznie działać (każde otwarcie strony +1, odświeżanie co 30 s)
-- ================================================
...
-- Funkcja atomowego zliczania (każde wywołanie: +1 i zwraca nowy stan)
