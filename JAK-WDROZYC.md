...
### ↩️ WERSJA MOBILNA — COFNIĘTA
- Usunięto menu hamburgerowe, menu mobilne i wszystkie poprawki responsywności dodane dla wersji mobilnej (zgodnie z prośbą).
- Strona wraca do poprzedniego wyglądu; na telefonie nawigacja główna pozostaje ukryta (jak wcześniej).
- Licznik wyświetleń 👁️ pozostaje.

### 🆕 WERSJA MOBILNA 📱 (dopracowana)
- Dodany breakpoint **xs (400px)** do Tailwinda.
- **Hero**: grafika mniejsza na telefonie (min-h 200px), plakietka skrócona.
- **Kafelki Aktualności**: mniejsze zdjęcia na mobile.
- **Baner O NAS**: niższy na telefonie.
- **Banner Piekarnia Kozielski**: przycisk „Szczegóły” pełna szerokość na mobile.
- **Karty komisji**: mniejszy padding na telefonie.
- **Panel Sesje Rady**: mniejsze tytuły na mobile.
- **Pasek górny**: e-mail skrócony do „E-mail” na bardzo małych ekranach.

### 🆕 WERSJA MOBILNA 📱
- **Menu hamburgerowe** na telefonie (przycisk ☰ w nagłówku) — wysuwane menu z prawej strony z pełną nawigacją (strona główna, wszystkie artykuły, sesje, forum, ogłoszenia, kontakt, O nas, asystent, e-Sesja, UG, FB).
- **Poprawki responsywności**: mniejsze tytuły sekcji na mobile, lepsze marginesy modalów (formularze nie wychodzą poza ekran), hero dopasowany, stopka w 1 kolumnie na telefonie, licznik mniejszy.

### 🆕 CZAT ASYSTENTA 💬
- **Chmurka czatu** w prawym dolnym rogu (💬) + otwiera się po kliknięciu „🧭 Asystent” w zakładkach górnych oraz e-maila kontakt@mszana.info w pasku.
- Formularz: **Imię, Nazwisko, E-mail, Wiadomość** → po wysłaniu **powiadomienie e-mail na kontakt@mszana.info** (FormSubmit) z tymi danymi + zapis kopii w Supabase (tabela ).
- **WAŻNE — 1 raz**: uruchom **** (SQL Editor) — wtedy wiadomości zapisują się też w tabeli.
- **WAŻNE — aktywacja e-maila**: pierwsza wysyłka przez FormSubmit wyśle na kontakt@mszana.info e-mail aktywacyjny — kliknij w link, by potwierdzić; od tej chwili wszystkie wiadomości z czatu będą przychodzić na tę skrzynkę.
