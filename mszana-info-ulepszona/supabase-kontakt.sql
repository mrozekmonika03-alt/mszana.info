-- ================================================
-- CZAT ASYSTENTA — tabela wiadomości (Supabase)
-- Jak użyć:
--   1. https://supabase.com/dashboard → projekt → SQL Editor → New query
--   2. Wklej całość → RUN (Ctrl+Enter)
--   3. Wiadomości z czatu będą się zapisywać w tabeli kontakt_widget
--      (e-mail i tak leci na kontakt@mszana.info przez FormSubmit)
-- ================================================
